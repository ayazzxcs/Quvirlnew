...
function teaserCard(p) {
  return `<article class="item">
    ...
    <div>
      ...
      <p class="muted">${esc(p.category)} • DropTrend Score ${Math.round(num(p.score))}/100</p>
...
function landingTemplate(page, products) {
  const title = `${page.title} | DropTrend`;
  const desc = page.description;
  const url = `${SITE_URL}/${page.slug}/`;
  const faq = [
    { q: `What is ${page.title}?`, a: `${page.title} is a DropTrend research page built from monthly dropshipping market signals, supplier data, Google Trends indicators and Amazon demand signals.` },
    { q: 'Is this updated live every day?', a: 'No. DropTrend focuses on monthly trend intelligence because dropshippers usually need stable demand, not short-lived daily spikes.' },
...
<section class="card">
<h2>How DropTrend selected these products</h2>
<p>DropTrend ranks products using a combination of supplier availability, estimated profit margin, Google Trends movement, Amazon demand validation and product research confidence. This page is designed for dropshippers who want monthly product research ideas instead of unstable daily hype.</p>
  ...
  const landingPages = [
    {
      ...
      description: 'Monthly DropTrend list of top dropshipping products based on Google Trends, Amazon demand and supplier signals.',
      intro: 'Explore the strongest monthly product opportunities ranked by DropTrend score, supplier data, Google Trends movement and Amazon demand validation.',
      pick: list => list,
      priority: '0.9'
    },
    {
    ...
    },
    {
      ...
      description: 'High margin dropshipping product ideas selected from DropTrend monthly product research data.',
    ...
    },
    {
      ...
      description: 'Best dropshipping products for 2026 based on monthly DropTrend product research signals.',
    ...
    },
    {
      ...
      description: 'Best TikTok product ideas to sell using dropshipping, selected from DropTrend monthly trend signals.',
    ...
    },
    {
      ...
      description: 'High margin dropshipping products to sell based on estimated profit, supplier data and DropTrend score.',
  ...
  const blogPages = [
    {
      ...
      intro: 'This guide summarizes strong product opportunities from DropTrend monthly market signals for dropshippers planning 2026 product tests.',
      pick: list => list,
      limit: 24
    },
    {
    ...
    },
    {
      ...
      description: 'High margin product ideas for dropshipping stores using DropTrend research data.',
