...
<div class="badge">`);
  ...
  <div class="hubCopy">
    <span>Live product research network</span>
    <h2>Connect demand, suppliers and selling channels before you test.</h2>
    <p>Quvirl pulls market signals into one visual hub so dropshippers can compare products before wasting budget.</p>
  </div>
  <div class="hubMap" aria-hidden="true">
    <div class="hubWire w1"></div><div class="hubWire w2"></div><div class="hubWire w3"></div><div class="hubWire w4"></div><div class="hubWire w5"></div><div class="hubWire w6"></div><div class="hubWire w7"></div><div class="hubWire w8"></div>
    <div class="hubCore"><b><span class="brandQu">Qu</span><span class="brandVirl">virl</span></b><small>Signal Hub</small></div>
    <div class="hubNode n1">Google<br><small>Trends</small></div>
    <div class="hubNode n2">Amazon<br><small>Demand</small></div>
    <div class="hubNode n3">CJ<br><small>Supplier</small></div>
    <div class="hubNode n4">Profit<br><small>Margin</small></div>
    <div class="hubNode n5">SEO<br><small>Pages</small></div>
    <div class="hubNode n6">TikTok<br><small>Ideas</small></div>
    <div class="hubNode n7">Shopify<br><small>Testing</small></div>
    <div class="hubNode n8">Winning<br><small>Score</small></div>
  </div>
</section>`;
...
.hero,.topNav,.toolbar,.premiumTrending,.winningPanel,.panel,.grid,.winnerGrid,.calc,.calculator,.marginCalculator,.marginCalc{max-width:100%!important;box-sizing:border-box!important}
...
.quvirlSignalHub{width:min(980px,100%);margin:28px auto 8px;padding:22px 24px;border-radius:30px;background:radial-gradient(circle at 50% 50%,rgba(34,197,94,.20),transparent 36%),linear-gradient(180deg,rgba(0,0,0,.72),rgba(0,0,0,.88));border:1px solid rgba(110,231,183,.24);box-shadow:0 28px 90px rgba(0,0,0,.55),inset 0 1px 0 rgba(255,255,255,.05);display:grid;grid-template-columns:.9fr 1.1fr;gap:20px;align-items:center;overflow:hidden}.hubCopy{text-align:left}.hubCopy span{text-transform:uppercase;letter-spacing:.12em;font-size:12px;font-weight:900;color:#6ee7b7!important}.hubCopy h2{margin:8px 0 10px!important;font-size:clamp(26px,3vw,42px)!important;line-height:1.05!important}.hubCopy p{font-size:16px!important;line-height:1.55!important;color:#fff!important}.hubMap{position:relative;height:420px;min-height:420px}.hubCore{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:190px;height:130px;border-radius:26px;background:linear-gradient(135deg,#11b73e,#00d084);display:grid;place-items:center;align-content:center;box-shadow:0 0 0 1px rgba(255,255,255,.16) inset,0 0 55px rgba(34,197,94,.45);z-index:3}.hubCore b{font-size:34px!important;line-height:1!important}.hubCore small{font-weight:900;color:#fff!important;opacity:.9}.hubNode{position:absolute;width:118px;min-height:74px;border-radius:22px;background:#fff;color:#05070b!important;font-weight:950;display:grid;place-items:center;text-align:center;box-shadow:0 16px 38px rgba(0,0,0,.45);z-index:4;font-size:15px;line-height:1.1}.hubNode small{color:#23272f!important;font-weight:800;font-size:12px}.hubNode::after{content:"";position:absolute;width:14px;height:14px;border-radius:50%;background:#22c55e;box-shadow:0 0 16px rgba(34,197,94,.8)}.n1{left:8%;top:12%}.n2{right:8%;top:10%}.n3{right:2%;top:42%}.n4{right:12%;bottom:8%}.n5{left:18%;bottom:4%}.n6{left:2%;top:42%}.n7{left:18%;top:68%}.n8{left:40%;top:2%}.n1::after,.n6::after,.n7::after{right:-22px;top:50%}.n2::after,.n3::after,.n4::after{left:-22px;top:50%}.n5::after{right:18px;top:-22px}.n8::after{left:50%;bottom:-22px}.hubWire{position:absolute;left:50%;top:50%;height:2px;background:linear-gradient(90deg,rgba(110,231,183,.08),rgba(110,231,183,.7));transform-origin:left center;z-index:1}.w1{width:205px;transform:rotate(210deg)}.w2{width:205px;transform:rotate(330deg)}.w3{width:215px;transform:rotate(0deg)}.w4{width:205px;transform:rotate(42deg)}.w5{width:180px;transform:rotate(120deg)}.w6{width:215px;transform:rotate(180deg)}.w7{width:190px;transform:rotate(145deg)}.w8{width:160px;transform:rotate(270deg)}
...
console.log(`Applied consolidated Quvirl branding with signal hub. Text-updated files: ${changed}.`);
