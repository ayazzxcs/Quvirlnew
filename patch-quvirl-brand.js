...
<div class="badge">`);
  ...
  <div class="hubCopy">
    ...
    <h2>Three signals, one product decision.</h2>
    <p>Quvirl connects Google Trends, Amazon demand and CJ supplier data so you can compare products faster.</p>
  </div>
  <div class="hubMap" aria-hidden="true">
    <div class="hubWire w1"></div><div class="hubWire w2"></div><div class="hubWire w3"></div>
...
console.log(`Applied consolidated Quvirl branding with 3-source signal hub. Text-updated files: ${changed}.`);
