...
.quvirlSignalHub{width:min(980px,100%);margin:28px auto 8px;padding:26px 18px;border-radius:30px;background:radial-gradient(circle at 50% 50%,rgba(34,197,94,.24),transparent 38%),linear-gradient(180deg,rgba(0,0,0,.76),rgba(0,0,0,.90));border:1px solid rgba(110,231,183,.24);box-shadow:0 28px 90px rgba(0,0,0,.55),inset 0 1px 0 rgba(255,255,255,.05);display:block!important;overflow:hidden}.hubMap{position:relative;width:100%;max-width:720px;height:390px;min-height:390px;margin:0 auto}.hubCore{position:absolute;left:50%;top:57%;transform:translate(-50%,-50%);width:220px;height:138px;border-radius:28px;background:linear-gradient(135deg,#11b73e,#00d084);display:grid;place-items:center;align-content:center;box-shadow:0 0 0 1px rgba(255,255,255,.16) inset,0 0 65px rgba(34,197,94,.52);z-index:3}.hubCore b{font-size:38px!important;line-height:1!important}.hubCore small{font-weight:900;color:#fff!important;opacity:.95}.hubNode{position:absolute;width:150px;min-height:88px;border-radius:24px;background:#fff;color:#05070b!important;font-weight:950;display:grid;place-items:center;text-align:center;box-shadow:0 16px 38px rgba(0,0,0,.45);z-index:4;font-size:17px;line-height:1.1}.hubNode small{color:#23272f!important;font-weight:800;font-size:12px}.hubNode::after{content:"";position:absolute;width:15px;height:15px;border-radius:50%;background:#22c55e;box-shadow:0 0 16px rgba(34,197,94,.8)}.n1{left:7%;top:42%}.n2{right:7%;top:42%}.n3{left:50%;top:7%;transform:translateX(-50%)}.n1::after{right:-26px;top:50%}.n2::after{left:-26px;top:50%}.n3::after{left:50%;bottom:-26px}.hubWire{position:absolute;left:50%;top:57%;height:2px;background:linear-gradient(90deg,rgba(110,231,183,.08),rgba(110,231,183,.72));transform-origin:left center;z-index:1}.w1{width:270px;transform:rotate(180deg)}.w2{width:270px;transform:rotate(0deg)}.w3{width:165px;transform:rotate(270deg)}
...
console.log(`Applied consolidated Quvirl branding with centered 3-source signal hub. Text-updated files: ${changed}.`);
